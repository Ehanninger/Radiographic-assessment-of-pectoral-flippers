# Radiographic assessment of pectoral flippers

This repository currently contains R code supporting analyses of radiographic pectoral flipper ossification in common dolphins (*Delphinus delphis*). The code was developed to support probabilistic inference of sexual maturity and comparative evaluation of radiographic ossification frameworks.

## Scope and associated publications
...
- R scripts for data processing, statistical modelling, and figure generation  


## Contact

For questions regarding the code or its use, please contact:  
Eva-Maria F. Hanninger
